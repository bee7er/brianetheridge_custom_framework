    ...
    $.cookieCuttr = function (options) {
        ...
        if (($cookieAccepted) || ($cookieDeclined)) {
            ...
            if ( (cookieDiscreetLink) && (!cookiePolicyPage) ) { // show discreet link
                ...
                $('body').prepend('<div class="cc-cookies ' + cookieOverlay + '">' + cookieAnalyticsMessage + cookieAccept + cookieDecline + '<a target="_blank" href="' + cookieWhatAreTheyLink + '" title="Visit All about cookies (External link)" class="cc-cookie-info">'+cookieWhatAreLinkText+'</a></div>');
            }
