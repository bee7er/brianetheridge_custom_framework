<?php // $Id$
    ...
    class HtmlSanitizer
    {
        ...
        function resetAll()
        {
            ...
            $this->_allowedTags = '<ul><ol><li><p><b><br><strong>';
        ...
        function removeEvilTags( $str )
        {
            ...
            // this method has been modified from this point onwards - JI / 30/04/2010

            if (is_array($str)) { // to allow for checkbox arrays (or array of arrays)
            	foreach ($str as $var => $val) {
					$str[$var] = $this->removeEvilTags($val);
            	}
				return $str;
            } else {
